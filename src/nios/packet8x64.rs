...
use crate::nios::constants::{
    NIOS_PKT_8X64_MAGIC, NIOS_PKT_FLAG_WRITE, NIOS_PKT_IDX_ADDR, NIOS_PKT_IDX_FLAGS,
...
impl NiosPacket8x64 {
    ...
    pub fn set(&mut self, target_id: u8, flags: u8, addr: u8, data: u64) {
        self.set_magic(NIOS_PKT_8X64_MAGIC);
